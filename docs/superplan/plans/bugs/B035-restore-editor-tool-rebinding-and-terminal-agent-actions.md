...
- response rail: keep immutable runtime/model/reasoning evidence, group Copy and `Completed in N.Ns` together at the conversation end, and add no feedback/voting controls
