...
**Goal:** Preserve IdeaSlide's mature drawing and presentation behavior while making each `.is v1` file an independent IdeaSketch document in the new multi-file shell.
