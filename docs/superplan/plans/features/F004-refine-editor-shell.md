...
**Goal:** Make IdeaNote's three-pane editor feel like one deliberate visual workspace while fixing the unstable Canvas controls and making panel resizing self-evident.
...
**Change Map:**
- `.temp/f004-editor-shell-prototype/index.html`: representative IdeaNote shell, Workspace resources, Canvas toolbar/island, and Cameras content
